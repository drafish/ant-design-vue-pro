...
const CreateForm = Form.create()({
  props: ["modalVisible", "handleAdd", "handleModalVisible"],
  render() {
...
const UpdateForm = Form.create()({
  ...
  methods: {
    handleNext(currentStep) {
      ...
      const { formVals: oldValue } = this.$data;
      form.validateFields((err, fieldsValue) => {
        if (err) return;
...
const TableList = {
  ...
  methods: {
    ...mapActions("rule", ["fetch", "add", "remove", "update"]),
      ...
      return (
        <Form onSubmit={this.handleSearch} layout="inline">
          <Row gutter={{ md: 8, lg: 24, xl: 48 }}>
            ...
            <Col md={8} sm={24}>
              <span class={styles.submitButtons}>
                ...
                <a style={{ marginLeft: "8px" }} onClick={this.toggleForm}>
                  展开 <Icon type="down" />
                </a>
              </span>
            </Col>
      ...
      <div>
        <Card bordered={false}>
          <div class={styles.tableList}>
            <div class={styles.tableListForm}>{this.renderForm()}</div>
            <div class={styles.tableListOperator}>
              <Button
                icon="plus"
                type="primary"
            ...
            <StandardTable
              ...
              selectRow={this.handleSelectRows}
              change={this.handleStandardTableChange}
            />
          </div>
        </Card>
        <CreateForm {...{ props: parentMethods }} modalVisible={modalVisible} />
